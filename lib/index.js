...
var _observerNext = require("./utils/observerNext");

Object.keys(_observerNext).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _observerNext[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _observerNext[key];
    }
  });
});
