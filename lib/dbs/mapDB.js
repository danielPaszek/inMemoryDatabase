...
var MapDB = /*#__PURE__*/function (_BaseDB) {
  ...
  _createClass(MapDB, [{
    key: "_pop",
    value: function _pop(id) {
      if (typeof id === "string" || _typeof(id) === "symbol" || typeof id === "number") {
        var result = this.db.get(id);
        this.db["delete"](id);
        return result;
      } else {
        var _result = this.db.get(id.id);
    ...
    value: function _get(id) {
      if (id) {
        if (typeof id === "string" || _typeof(id) === "symbol" || typeof id === "number") return this.db.get(id);else return this.db.get(id.id);
      }
